...
# from langchain_core.utils import maximal_marginal_relevance
...
class OpenSearchVectorStore(VectorStore):
    ...
    Example:
        .. code-block:: python
            ...
            opensearch_vector_search = OpenSearchVectorStore(
                "http://localhost:9200",
                "embeddings",
                embedding_function
            )
    ...
    async def __aadd(
        ...
        **kwargs: Any,
        ...
        if self.async_client is None:
            raise ValueError("AsyncOpenSearch client is not initialized. Ensure opensearch-py is installed and opensearch_url is provided.")  # type: ignore[return]
        bulk_size = bulk_size if bulk_size is not None else self.bulk_size
        _validate_embeddings_and_bulk_size(len(embeddings), bulk_size)
        index_name = kwargs.get("index_name", self.index_name)
        text_field = kwargs.get("text_field", "text")
    ...
    def add_embeddings(
        ...
        **kwargs: Any,
        ...
        Optional Args:
            ...
            to "text".
        """
        texts, embeddings = zip(*text_embeddings, strict=False)
        bulk_size = bulk_size if bulk_size is not None else self.bulk_size
        return self.__add(
            list(texts),
            list(embeddings),
    ...
    async def adelete(
        ...
        if self.async_client is None:
            raise ValueError(
                "AsyncOpenSearch client is not initialized. Ensure opensearch-py is installed and opensearch_url is provided."
            )
        if ids is None:
    ...
    def max_marginal_relevance_search(
        ...
        **kwargs: Any,
        ...
        # raise NotImplementedError("MMR search needs to be updated for current langchain-core version")
    ...
    def from_texts(
        ...
        **kwargs: Any,
        ...
        """Construct OpenSearchVectorStore wrapper from raw texts.
        ...
        Example:
            .. code-block:: python
                ...
                opensearch_vector_search = OpenSearchVectorStore.from_texts(
                    texts,
                    embeddings,
        ...
        index_name = get_from_dict_or_env(
            kwargs, "index_name", "OPENSEARCH_INDEX_NAME", default=None
        )  # Get potential index_name
        if index_name:
    ...
    async def afrom_texts(
        ...
        **kwargs: Any,
        ...
        """Asynchronously construct OpenSearchVectorStore wrapper from raw texts.
                ...
                Example:
                    .. code-block:: python
                        ...
                        opensearch_vector_search = await OpenSearchVectorStore.afrom_texts(
                            texts,
                            embeddings,
                            opensearch_url="http://localhost:9200"
                        )
    ...
    def from_embeddings(
        ...
        **kwargs: Any,
        ...
        """Construct OpenSearchVectorStore wrapper from pre-vectorized embeddings.
        ...
        Example:
            .. code-block:: python
                ...
                opensearch_vector_search = OpenSearchVectorStore.from_embeddings(
                    embeddings,
                    texts,
                    embedder,
                    opensearch_url="http://localhost:9200"
    ...
    async def afrom_embeddings(
        ...
        **kwargs: Any,
        ...
        """Asynchronously construct OpenSearchVectorStore wrapper from pre-vectorized
        embeddings.
        ...
        Example:
            .. code-block:: python
                ...
                opensearch_vector_search =
                    await OpenSearchVectorStore.afrom_embeddings(
                        embeddings,
                        texts,
                        embedder,
                        opensearch_url="http://localhost:9200"
